            ...
            <div className="h-screen md:grid md:grid-cols-6 w-full gap-4 p-12 md:p-6 relative">
                ...
                {selectedJob && (
                    <button
                        ...
                        className="fixed cursor-pointer bottom-6 md:bottom-10 right-6 md:right-10 w-fit px-4 py-2 h-10 md:w-12 md:h-12 flex items-center justify-center gap-4 rounded-xl bg-gray-100/50 hover:bg-gray-200/50 backdrop-blur transition-colors text-gray-600 hover:text-gray-800"
